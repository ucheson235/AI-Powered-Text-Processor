...
//   const [detectedLang, setDetectedLang] = useState(""); // Detected language (full name)
//   const [detectedLangCode, setDetectedLangCode] = useState(""); // Detected language code
//   const [selectedLanguage, setSelectedLanguage] = useState("en"); // Selected language for translation
...
//         setDetectedLang("English"); // Default to English
//         setDetectedLangCode("en"); // Default to English code
//       } else {
...
//         setDetectedLangCode(detectionResult.detectedLanguage); // Store the language code
//       }
...
//       setOutputText(summary); // Replace output text with summary
//     } catch (err) {
...
//               {/* Summarize Button */}
//               {outputText.length > 150 && detectedLangCode === "en" && (
